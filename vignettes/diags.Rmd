---
title: "Stock Assessment Diagnostics"
...
load("/home/laurie/Desktop/flr/diags/data/dgs.RData")
#data(dgs)
```
...
library(GGally)
library(stringr)
dirVPA="/home/laurie/ownCloud/GVYP_VPA/BFTAss/Analysis/vpa/east/reported/med"

dgs=diags:::diags.vpa2box(file.path(dirVPA,"MINUS0.R"))
dgs=cbind(dgs[,-(3:4)],(ddply(dgs,.(name),with, broomify(lm(y~x-1)))))
dgs=transform(dgs,yhat=y+residual)
